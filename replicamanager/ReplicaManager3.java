package src.main.java.replicamanager;
...
import src.main.java.replicas.winyul.dtrs.Server;
import src.main.java.replicas.winyul.dtrs.com.web.service.DTRSWebServices;
...
//					String temp[] = msg.split("-");
					String city = temp[1];
					int recvPort = Integer.parseInt(temp[0]);
					if (rmPort == recvPort) {
...
//				sendPacket(dgram.getAddress(), dgram.getPort(), returnVal);
				sendPacket(InetAddress.getByName("192.168.42.203"), 8999, returnVal == null ? "" : returnVal);
			} catch (Exception e) {
